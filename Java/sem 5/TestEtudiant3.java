...
public class TestEtudiant3{
	...
	public static java.util.Scanner scanner = new java.util.Scanner(System.in);
   	...
   	public static void main(String [] args){
		...
		do{
			...
			System.out.println("5 -> Teste la methode nombreUEValidees");
			System.out.print("\nEntrez votre choix : ");
			...
			switch(choix){
				...
				case 5: verifierUEValidees(); break;
				}
	...
	private static void verifierUEValidees(){ 
		boolean tousReussis = true;
		Etudiant etudiant;
		int valide;
		// Test1 : 3 cotes - tous reussi
		
		double[] tableTestee1 = {17,14,16};
		etudiant = new Etudiant(1,tableTestee1);
		valide = etudiant.nombreUEValidees();
		if(valide != 3){
			System.out.print("\nAttention! Test1 ko : votre methode a trouve "+ valide +" comme la plus grande cote");
			System.out.println(" pour l'etudiant : "+ etudiant.toString());
			tousReussis = false;	
		}
		
		// Test2 : 5 cotes - 4 reussies
		double[] tableTestee2 = {13,14,16,8,17};
		etudiant = new Etudiant(2,tableTestee2);
		valide = etudiant.nombreUEValidees();
		if(valide != 4){
			System.out.print("\nAttention! Test2 ko : votre methode a trouve "+ valide +" comme la plus grande cote");
			System.out.println(" pour l'etudiant : "+ etudiant.toString());
			tousReussis = false;	
		}
	
		// Test3 : 5 cotes - avec 5 reussi dont un echec a 9 et moyenne sup a 12
		double[] tableTestee3 = {15,14,16,9,17};
		etudiant = new Etudiant(3,tableTestee3);
		valide = etudiant.nombreUEValidees();
		if(valide != 5){
			System.out.print("\nAttention! Test3 ko : Votre methode a trouve "+ valide +" comme la plus grande cote");
			System.out.println(" pour l'etudiant : "+ etudiant.toString());
			tousReussis = false;	
		}
		
		//Test4 : 5 cotes et 0 reussies
		double[] tableTestee4 = {5,4,6,9,7};
		etudiant = new Etudiant(4,tableTestee4);
		valide = etudiant.nombreUEValidees();
		if(valide != 0){
			System.out.print("\nAttention! Test3 ko : Votre methode a trouve "+ valide +" comme la plus grande cote");
		...
		//Test 5 : 5 cotes - 3 valide 2 echecs.
		double[] tableTestee5 = {18,17,19,9,7};
		etudiant = new Etudiant(5,tableTestee5);
		valide = etudiant.nombreUEValidees();
		if(valide != 3){
			System.out.print("\nAttention! Test3 ko : Votre methode a trouve "+ valide +" comme la plus grande cote");
			System.out.println(" pour l'etudiant : "+ etudiant.toString());
