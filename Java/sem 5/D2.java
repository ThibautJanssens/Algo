...
public class D2 {
	...
	public static void main(String[] args) {
		...
		while(!estTermine()){
			...
			afficher(plateau);
			System.out.println("\nQuel case voulez vous jouez? (case de 0 à 15)");
			choix = scanner.nextInt();
			
			while(joueur() == "blanc" && plateau[choix] == 1){
				System.out.println("Vous avez tenté de jouer une case qui n'est pas la votre.");
				afficher(plateau);
				System.out.println("\nQuel case voulez vous jouez?");
				choix = scanner.nextInt();
			}
			while(joueur() == "noir" && plateau[choix] == 0){
				System.out.println("Vous avez tenté de jouer une case qui n'est pas la votre.");
				afficher(plateau);
				System.out.println("\nQuel case voulez vous jouez?");
				choix = scanner.nextInt();
			...
			while (joueur() == "blanc" && plateau[choix] == -1){
				System.out.println("Vous avez tenté de jouer une case vide.");
				afficher(plateau);
				System.out.println("\nQuel case voulez vous jouez?");
				choix = scanner.nextInt();
			}
			while (joueur() == "noir" && plateau[choix] == -1){
				System.out.println("Vous avez tenté de jouer une case vide.");
				afficher(plateau);
				System.out.println("\nQuel case voulez vous jouez?");
				choix = scanner.nextInt();
