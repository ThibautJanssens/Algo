public class TestParticipants{
	...
	private static void ajouter(){
		...
		// test 4 : ajout dans une table qui contient deja le participant (homonyme accepte!)
		try{
			String[] t = {"p1","p2","p3"};
			Participants tP = new Participants(4,t);
	...
	private static void supprimer(){
		...
		// test 2 : suppression dans une table non vide et non pleine qui ne contient pas le participant
		try{
			String[] t = {"p1","p2","p3"};
			Participants tP = new Participants(4,t);
		...
		// test 3 : suppression dans une table non vide et non pleine qui contient le participant
		try{
			String[] t = {"p1","p2","p3"};
			Participants tP = new Participants(4,t);
			String[] tSol = {"p1","p3"};
		...
		// test 4 : suppression dans une table pleine qui ne contient pas le participant
		try{
			String[] t = {"p1","p2","p3","p4"};
			Participants tP = new Participants(4,t);
			String[] tSol = {"p1","p2","p3","p4"};
		...
		// test 5 : suppression dans une table pleine qui contient le participant
		try{
			String[] t = {"p1","p2","p3","p4"};
			Participants tP = new Participants(4,t);
		...
		// test 6 : suppression dans une table pleine qui contient le participant en premier lieu
		try{
			String[] t = {"p1","p2","p3","p4"};
			Participants tP = new Participants(4,t);
		...
		// test 7 : suppression dans une table pleine qui contient le participant en dernier lieu
		try{
			String[] t = {"p1","p2","p3","p4"};
			Participants tP = new Participants(4,t);
			String[] tSol = {"p1","p2","p3"};
